...
import com.hieu.moneybank.shared.observability.CorrelationIdFilter;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(MoneyBankException.class)
    public ResponseEntity<ApiErrorResponse> handleMoneyBankException(MoneyBankException exception) {
