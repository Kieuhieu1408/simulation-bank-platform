...
@Getter
@Entity
@Table(name = "bank_transactions", uniqueConstraints = @UniqueConstraint(name = "uk_idempotency_key", columnNames = "idempotency_key"), indexes = {
...
public class BankTransaction {
    ...
    public BankTransaction(Account source, Account destination, BigDecimal amount, String currency, String key, String description) {
