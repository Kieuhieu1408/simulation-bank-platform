...
public class SecurityConfig {
     ...
     */
    @Bean
    public JwtDecoder jwtDecoder(CommonSecurityProperties properties) {
     ...
     */
    @Bean
    public JwtAuthenticationConverter jwtAuthenticationConverter(CommonSecurityProperties properties) {
